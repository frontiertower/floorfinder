...
import { Blueprint } from './blueprints/floor-6';
...
export const Floor6: React.FC<Floor6Props> = ({ highlightedRoomId, onRoomClick, rooms, onMouseEnterRoom, onMouseLeaveRoom, viewBox }) => {
